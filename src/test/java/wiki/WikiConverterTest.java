...
public class WikiConverterTest {
	...
	private void displayInfo() {
		...
		printer.setHeaders("Url", "Number of Igored Tables", "Number of Extracted tables", "Total");//optional - if not used then there will be no header and horizontal lines
